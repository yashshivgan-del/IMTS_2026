            ...
            "content": [
                {
                    ...
                    "text": (
                        ...
                        "- There is a BLACK FILLED CIRCLE marker on the mat. This circle marks the TOP of the mat.\n"
                        "- The ROBOTIC ARM BASE is at the BOTTOM of the image.\n"
                        "- The LARGE PINK grid is in the RIGHT portion of the image.\n\n"
                        "GRID LAYOUT (large pink grid, 3 rows x 2 columns):\n"
                        "- Row A = the row CLOSEST to the black circle (TOP of grid, farthest from arm)\n"
                        "- Row B = middle row\n"
                        "- Row C = the row CLOSEST to the arm base (BOTTOM of grid)\n"
                        "- Column 1 = RIGHT column\n"
                        "- Column 2 = LEFT column\n\n"
                        "There is also a SMALLER grid elsewhere (4 cells, no pink border) — this is the pick zone, IGNORE IT.\n\n"
                        "Step 1: Locate the black circle. Confirm it is near the top of the image.\n"
                        "Step 2: Identify which row of the pink grid is closest to the black circle — that is Row A.\n"
                        "Step 3: Label all 6 cells accordingly.\n\n"
                        "Report:\n"
                        "- A1: [color or empty]\n"
                        "- A2: [color or empty]\n"
                        "- B1: [color or empty]\n"
