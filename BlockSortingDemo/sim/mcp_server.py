            ...
            "content": [
                {
                    ...
                    "text": (
                        ...
                        "These are two distinct physical objects sitting apart from each other on the mat — do not merge them.\n\n"
                        "STEP 1: First locate the LARGE grid by its PINK border. Ignore everything outside that pink border completely. "
                        "Any block sitting in the plain white grid is OUTSIDE the pink border and must NOT appear in your answer.\n\n"
                        "STEP 2: The pink grid has 6 cells (3 rows x 2 columns), labeled A1, A2, B1, B2, C1, C2. "
                        "Read the labels directly as printed. "
                        "In this image: column 2 (A2, B2, C2) is on the LEFT, column 1 (A1, B1, C1) is on the RIGHT.\n\n"
                        "STEP 3: For ONLY the 6 cells inside the pink border, report contents:\n"
                        "- A1: [color or empty]\n"
                        "- A2: [color or empty]\n"
                        "- B1: [color or empty]\n"
                        "- B2: [color or empty]\n"
                        "- C1: [color or empty]\n"
                        "- C2: [color or empty]\n\n"
                        "Before answering, verify: does every cell you listed have a pink border on at least one side? "
                        "If a block is not inside the pink-bordered grid, do not mention it anywhere in the output.\n"
